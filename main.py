...
dim_fourier_encoding=64 #multiple of 4!! 512 in geoCLIP, folowed by "four hidden layers (each with ReLU activation and 1024 dimensions), and an output layer of 512 dimensions"
dim_hidden=256
